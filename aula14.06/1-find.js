...
//console.log(bonde.find((pessoa) => pessoa.saldoNaConta.length > 5000));
...
//console.log(bonde.every((pessoa) => pessoa.pets === true));
...
// Todas as pessoas do bonde que nãio sejam vegetarianas
//const bondeNaoVeg = bonde.filter((pessoa) => pessoa.vegetariana == !true);
//console.log(bondeNaoVeg);

//Todas as pessoas que tem mais de 50 reais na conta
//const rycas = bonde.filter((pessoa) => pessoa.saldoNaConta > 50);
//console.log(rycas); 

//Foreach 
/*bonde.forEach((pessoa, index) => console.log(
  `A pessoa no indez ${index} se chama ${pessoa.apelido} e tem ${pessoa.idade} anos`
));*/
